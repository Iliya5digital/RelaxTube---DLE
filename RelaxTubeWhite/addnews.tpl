<div class="fullstory addnews"> 
	...
	<table class="fulltable">
		...
		<tr  class="addvote" style="display:none;" >
			<td class="sline">Варианты ответов:<div class="answer_variant">Каждая новая строка является новым вариантом ответа</div></td>
			<td><textarea name="vote_body" class="f_textarea">{votebody}</textarea><br /><input type="checkbox" name="allow_m_vote" value="1" {allowmvote}>Разрешить выбор нескольких вариантов</td>
   		</tr>
   		<tr>
