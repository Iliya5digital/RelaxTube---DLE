<div class="fullstory">
  ...
  <div class="hblock cf">
    ...
    <div class="pm_main">
      [pmlist]
      <div class="mblock">
        <h3 class="block_header">Список сообщений</h3>
          {pmlist}
      </div>
      [/pmlist]
      <!-- Новое сообщение -->
    [newpm]
    <div class="mblock">
    <h2 class="post_title">Отправка персонального сообщения</h3>
    <table class="fulltable">
      ...
      [/sec_code]
        [recaptcha]
      <tr>
          <td class="sline">Введите два слова, показанных на изображении:</td>
          <td>{recaptcha}</td>
      </tr>
      [/recaptcha]
      [question]
